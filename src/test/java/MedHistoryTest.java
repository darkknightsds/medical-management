...
public class MedHistoryTest {
  ...
  public void MedHistory_instantiatesCorrectly_true(){
    MedHistory testMedHistory=new MedHistory(3, "recent patient", "Patient 0", "12/12/12", "tylenol", true);
  ...
  public void get_returnsAllPropertiesOfMedHistory_true(){
    ...
    assertEquals("12/12/12", testMedHistory.getDate());
  ...
  public void equals_retursTrueIfMedHistoriesAreTheSame_true(){
    MedHistory testMedHistory1 = new MedHistory(3, "recent patient", "Patient 0", "12/12/12", "tylenol", true);
    MedHistory testMedHistory2 = new MedHistory(3, "recent patient", "Patient 0", "12/12/12", "tylenol", true);
    assertTrue(testMedHistory1.equals(testMedHistory2));
  }

  @Test
  public void save_savesMedHistoryObjectInDB_true(){
    MedHistory medHistory = new MedHistory(2, "longtime patient", "Patient 4", "03/15/30", "advil", true);
    medHistory.save();
  ...
  public void all_returnsAllMedHistoriesFromDB_true(){
    ...
    MedHistory testMedHistory2 = new MedHistory(2, "longtime patient", "Patient 4", "03/15/30", "advil", false);
  ...
  public void find_returnsMedHistoryWithSameId(){
    MedHistory testMedHistory = new MedHistory(2, "longtime patient", "Patient 4", "03/15/30", "advil", true);
    testMedHistory.save();
    ...
    public void updateMedHistory_updatesMedHistoryProperties_true() {
      MedHistory testMedHistory = new MedHistory(3, "recent patient", "Patient 0", "12/12/12", "tylenol", true);
      testMedHistory.save();
      testMedHistory.updateMedHistory(2, "longtime patient", "Patient 4", "03/15/30", "advil", false);
      ...
      assertEquals("03/15/30", MedHistory.find(testMedHistory.getMedHistoryId()).getDate());
      assertEquals("03/15/30", testMedHistory.getDate());
